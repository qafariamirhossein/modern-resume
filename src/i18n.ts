...
Stack: TypeScript · Ethers.js · MongoDB · Alchemy · Telegram Bot API · etc.`
        ...
        devDiscuss: {
          title: "DevDiscuss – A Developer Forum with Rich Editor & Tagging",
          short: "A modern forum for developers with rich editor, tagging, and Telegram integration.",
          long: `A modern discussion forum for developers, focused on long-form, technical posts similar to dev.to or Hashnode. Built with Python, Jinja templates, and PostgreSQL for a robust developer community platform.\n\nFeatures:\n- Rich Text Editor: Code blocks, headings, inline code, and image support\n- Post Management: Create, edit, and manage posts with tags and categories\n- Draft System: Save posts as drafts for later completion\n- User Profiles: Detailed profiles with contributions and reputation scoring\n- Voting System: Upvote/downvote posts and comments\n- Advanced Search: Full-text fuzzy search with filtering options\n- Notification System: Real-time notifications for comments, replies, and mentions\n- Admin Panel: Comprehensive moderation and administration tools\n\nPhase 2: Telegram Integration\n- Telegram Source Management: Add and manage Telegram groups/channels\n- Automated Scraping: Scheduled content import from Telegram sources\n- Content Conversion: Convert Telegram messages to posts and replies to comments\n- User Mapping: Link Telegram users to DevDiscuss accounts\n- Background Processing: Asynchronous scraping with error handling\n- Admin Dashboard: Comprehensive Telegram source management interface\n\nTech Stack: Python (Flask/FastAPI), Jinja2, PostgreSQL, Prisma ORM, Telethon, HTML, CSS, JavaScript\n\nDevDiscuss – Where developers share, learn, and grow together! 🚀`
        }
      },
      contact: 'Contact Me',
      ...
      about_text: `I am AmirHossein Qafari, a passionate and ambitious software developer based in Tehran, Iran. With a strong foundation in both frontend and backend technologies—including React, Next.js, TypeScript, Node.js, and more—I thrive on building modern, impactful web applications. My portfolio showcases innovative projects like AI-powered tools, developer platforms, and automation solutions, reflecting my drive to solve real-world problems and push the boundaries of technology. I am a fast learner, a creative problem solver, and always eager to collaborate with others who share a love for technology and growth.\n\n Let's connect and create something amazing together!`,
      education_school: 'Islamic Azad University',
...
تکنولوژی‌ها: TypeScript · Ethers.js · MongoDB · Alchemy · Telegram Bot API و ...`
        ...
        devDiscuss: {
          title: "DevDiscuss – انجمن برنامه‌نویسان با ویرایشگر پیشرفته و تگ‌گذاری",
          short: "انجمن مدرن برای برنامه‌نویسان با ویرایشگر غنی، تگ‌گذاری و اتصال تلگرام.",
          long: `یک انجمن مدرن برای برنامه‌نویسان، متمرکز بر پست‌های فنی و بلند مشابه dev.to یا Hashnode. ساخته شده با پایتون، قالب‌های Jinja و پایگاه داده PostgreSQL برای ایجاد بستری قوی جهت جامعه توسعه‌دهندگان.\n\nویژگی‌ها:\n- ویرایشگر متنی پیشرفته: پشتیبانی از کد، تیتر، کد درون‌خطی و تصویر\n- مدیریت پست: ایجاد، ویرایش و مدیریت پست‌ها با تگ و دسته‌بندی\n- سیستم پیش‌نویس: ذخیره پست‌ها به عنوان پیش‌نویس برای تکمیل بعدی\n- پروفایل کاربری: پروفایل‌های کامل با امتیاز و مشارکت\n- سیستم رأی‌دهی: رأی مثبت/منفی برای پست‌ها و نظرات\n- جستجوی پیشرفته: جستجوی متنی کامل با فیلترهای متنوع\n- سیستم اعلان: اعلان لحظه‌ای برای نظرات، پاسخ‌ها و منشن‌ها\n- پنل مدیریت: ابزار کامل برای مدیریت و نظارت\n\nفاز دوم: اتصال به تلگرام\n- مدیریت منابع تلگرام: افزودن و مدیریت گروه‌ها/کانال‌ها\n- جمع‌آوری خودکار: وارد کردن محتوای تلگرام به صورت زمان‌بندی‌شده\n- تبدیل محتوا: تبدیل پیام‌های تلگرام به پست و پاسخ به نظر\n- نگاشت کاربر: اتصال کاربران تلگرام به حساب DevDiscuss\n- پردازش پس‌زمینه: جمع‌آوری غیرهمزمان با مدیریت خطا\n- داشبورد مدیریت: رابط کامل برای مدیریت منابع تلگرام\n\nتکنولوژی: پایتون (Flask/FastAPI)، Jinja2، PostgreSQL، Prisma ORM، Telethon، HTML، CSS، JavaScript\n\nDevDiscuss – جایی برای رشد و یادگیری برنامه‌نویسان! 🚀`
        }
      },
      contact: 'تماس با من',
      name: 'امیرحسین غفاری',
      ...
      linkedin: 'https://www.linkedin.com/in/amirhossein-qafari/',
      github: 'https://github.com/qafariamirhossein',
      about_text: `من امیرحسین قافری هستم؛ توسعه‌دهنده نرم‌افزار پرشور و بلندپرواز ساکن تهران. با تسلط بر فناوری‌های فرانت‌اند و بک‌اند—از جمله React، Next.js، TypeScript، Node.js و موارد دیگر—در ساخت اپلیکیشن‌های مدرن و تاثیرگذار وب تخصص دارم. نمونه‌کارهای من شامل پروژه‌های نوآورانه‌ای مانند ابزارهای مبتنی بر هوش مصنوعی، پلتفرم‌های توسعه‌دهندگان و راهکارهای اتوماسیون است که نشان‌دهنده علاقه من به حل مسائل واقعی و گسترش مرزهای فناوری است. یادگیرنده‌ای سریع، حل‌کننده خلاق مسائل و همیشه مشتاق همکاری با افرادی هستم که به رشد و فناوری علاقه دارند.\n\nبیایید با هم ارتباط بگیریم و چیزهای شگفت‌انگیزی خلق کنیم!`,
      education_school: 'دانشگاه آزاد اسلامی',
